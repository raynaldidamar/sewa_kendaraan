                        ...
                        <div class="card-body card-body-custom pt-4">
                            <div class="text-center">
                                ...
                                <ul class="list-unstyled list-style-group">
                                    ...
                                    <li class="border-bottom p-2 d-flex justify-content-between">
                                        <span>Plat Nomer</span>
                                        <span style="font-weight: 600">{{ $car->plat_nomer}}</span>
                                    </li>
                                    <li class="border-bottom p-2 d-flex justify-content-between">
                                        <span>Transmisi</span>
                        ...
                        <div class="card-footer border-top-0 bg-transparent">
                            <div class="text-center">
                                <a class="btn d-flex align-items-center justify-content-center btn-primary mt-auto"
                                    href="https://api.whatsapp.com/send?phone=6281554883042&text=Saya%20Tertarik%20untuk%20menyewa%20mobil%20{{ $car->nama_mobil }}%20ini%20segera%20"
