...
<head>
    ...
    <title>Contact Kami- Kurnia Rental Mobil</title>
    <!-- Favicon-->
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-dark">
        <div class="container px-4 px-lg-5">
            <a Start class="navbar-brand text-white" href="{{ route('homepage') }}">KurniaRental</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active text-white" href="{{ route('contact') }}">Contact</a>
                    </li>
                </ul>
            </div>
        </div>
