            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{route('admin.cars.update', $car->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="plat_nomer">Plat Nomer Kendaraan</label>
                            <input type="text" name="plat_nomer" class="form-control" value="{{old('plat_nomer', $car->plat_nomer)}}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="deskripsi" id="deskripsi" class="form-control" rows="5" cols="30">{{old('deskripsi', $car->deskripsi)}}</textarea>
                        </div>
